...
//asciinema: https://asciinema.org/a/xWRBXKJPHXb2Ca03KkrQchAfe
...
class Program
{
    static void Main()
    {
        string inputString = "radar";  // Cadena de ejemplo
    ...
    static bool IsPalindrome(string str, int len)
    {
        int start = 0;
        int end = len - 1;
        ...
        return true;  // Si se han comparado todos los caracteres, es un palíndromo
    }
}
*/
